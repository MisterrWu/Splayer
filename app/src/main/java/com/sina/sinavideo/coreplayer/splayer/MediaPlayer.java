...
public class MediaPlayer
{
    ...
    static {
    	try{
        	...
        	native_init("",SPLAYER_TRACE_ERROR, 1, 1);
    ...
    *enableFile: 1 log to file ; 0 not 
     ...
     * @param path the Uri from which to get the datasource
     * @param sv the SurfaceHolder to use for displaying the video
     ...
     * @param keys the headers associated with the http request for the stream you want to play
     ...
     * set with {@link #(SurfaceHolder)} and thus can use the
...
//    }
     ...
     *
     * @param msec total buffer time in mill second, default 5000 = 5 seconds
     */
