...
IJK_GLES2_Renderer *IJK_GLES2_Renderer_create(SDL_Overlay *overlay)
{
    if (!overlay)
        return NULL;
 ...
 * Per-Frame routine
 */
GLboolean IJK_GLES2_Renderer_renderOverlay(IJK_GLES2_Renderer *renderer, SDL_Overlay *overlay)
{
