...
#ifndef SPLAYER_LJSDL_OPENSLES_H
#define SPLAYER_LJSDL_OPENSLES_H
...
class AndroidOpenSLES
{
public:
    AndroidOpenSLES(const int id);
    ~AndroidOpenSLES();
...
private:
    ...
    void (*_callback)(void *opaque, char *stream, int len);//AudioDeviceBuffer* _ptrAudioBuffer;
    void *_opaque;

    SDL_Mutex* _critSect;//CriticalSectionWrapper& _critSect;
    int _id;
...
#endif //SPLAYER_LJSDL_OPENSLES_H
