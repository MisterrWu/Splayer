...
#include "ijksdl_gles2_internal.h"
...
static EGLBoolean IJK_EGL_prepareRenderer(IJK_EGL* egl, SDL_Overlay *overlay)
{
    assert(egl);
    assert(egl->opaque);
...
static EGLBoolean IJK_EGL_display_internal(IJK_EGL* egl, EGLNativeWindowType window, SDL_Overlay *overlay)
{
    IJK_EGL_Opaque *opaque = egl->opaque;
...
EGLBoolean IJK_EGL_display(IJK_EGL* egl, EGLNativeWindowType window, SDL_Overlay *overlay)
{
