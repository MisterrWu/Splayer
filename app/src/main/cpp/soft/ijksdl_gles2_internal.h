...
typedef struct IJK_GLES2_Renderer
{
    ...
    GLsizei   (*func_getBufferWidth)(IJK_GLES2_Renderer *renderer, SDL_Overlay *overlay);
    GLboolean (*func_uploadTexture)(IJK_GLES2_Renderer *renderer, SDL_Overlay *overlay);
...
IJK_GLES2_Renderer *IJK_GLES2_Renderer_create_yuv420sp_vtb(SDL_Overlay *overlay);
