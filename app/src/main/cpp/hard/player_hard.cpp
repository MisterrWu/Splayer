...
///��VideoState��ƵԴ�е�pictq������һVideoPicture��Ա��ʾ,��ʾǰ������Ļ
...
///#endif
    ...
    if (vp->bmp) {
        ...
        sws_scale(is->img_convert_ctx, src_frame->data, src_frame->linesize, 0, vp->height, pict.data, pict.linesize); ///sws_scale������ͼ�����ź͸�ʽת�����ú�������ʹ�ø��ֲ�ͬ�㷨����ͼ����д���
		*/
