...
enum video_scaling_mode{
	...
	VIDEO_SCALING_MODE_FULL_SCREEN,  //ȫ��ռ��
	VIDEO_SCALING_MODE_ORIGINAL  //ԭʼ�ߴ�
};
...
private:
	...
	void stream_toggle_pause(int unpause); //unpause 1ǿ�ƿ�ʼ 0 ��ת״̬
	void toggle_pause();
...
private:
    ...
    double audio_clock;
	double audio_clock_total; //m3u8ʱʹ�������clock
    ...
    struct AudioParams audio_src; ///�ļ�����������?
    struct AudioParams audio_tgt; ///�����Ӳ������������
	...
	//AVFrame *video_decode_frame; //Ӳ�������frameû��ʵ������ֻ��PTS
...
private:
    ...
    double frame_timer;  ///��Ƶ֡ͬ���ο���׼ʱ��
    double frame_last_pts;
	int frame_last_serial;  //Ϊ����϶�αֱ����ʱ�ῨBUG
    double frame_last_duration;
    double frame_last_dropped_pts;
    double frame_last_returned_time;
    double frame_last_filter_delay;
